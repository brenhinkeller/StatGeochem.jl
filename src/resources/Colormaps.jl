...
## --- Other colormaps
    ...
    mineralcolors["andradite"] = parse(Color, "#71331b")
    ...
    mineralcolors["pyroxene"] = parse(Color, "#343628")
    mineralcolors["clinopyroxene"] = parse(Color, "#262f01")
    mineralcolors["orthopyroxene"] = parse(Color, "#7e5933")
    mineralcolors["diopside"] = parse(Color, "#324b3a")
    mineralcolors["omphacite"] = parse(Color, "#34781b")
    mineralcolors["enstatite"] = parse(Color, "#37350e")
    mineralcolors["ferrosilite"] = parse(Color, "#3c1c07")
    ...
    mineralcolors["feldspar"] = parse(Color, "#00afa9")
    mineralcolors["microcline"] = parse(Color, "#00afa9")
    mineralcolors["orthoclase"] = parse(Color, "#ef9e90")
    mineralcolors["albite"] = parse(Color, "#00AAAE")
    mineralcolors["anorthite"] = parse(Color, "#00A98D")
