...
## --- GIS.jl
    ...
    A = [8 7 10 -1 -1; 5 2 2 -1 -1; 8 5 3 1 6; 8 10 3 9 5; 9 8 4 10 4]
    @test aveslope(A*1000, 1:4, 1:4, 1, Int64, minmatval=0, km_per_lat=111.1) ==
        [0 20 0 0 0; 19 23 8 0 0; 18 15 11 22 15; 6 0 15 35 16; 0 15 15 0 0]
    @test maxslope(A*1000, 1:4, 1:4, 1, minmatval=0, km_per_lat=111.1) ==
        [0 45 72 0 0; 27 16 32 0 6; 38 36 22 14 45; 25 23 22 41 36; 0 32 38 45 0]
    @test maxslope(A*1000, 1:4, 1:4, 1, Float16, minmatval=0, km_per_lat=111.1) ==
        Float16[0.0 45.0 72.0 0.0 0.0; 27.02 15.914 31.5 0.0 6.367; 38.22 36.0 22.3 13.52 45.06; 25.48 22.56 22.3 40.5 36.1; 0.0 31.86 38.22 44.6 0.0]
