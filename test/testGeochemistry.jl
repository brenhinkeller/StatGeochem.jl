...
## --- Geochemistry
    ...
    @test mineralcompositions["Zircon"] == Dict(:Th => 0.18, :Dy => 0.13, :Zr => 43.14, :Yb => 0.46, :Ho => 0.05, :Tm => 0.05, :Lu => 0.09, :Y => 1.34, :Si => 14.76, :U => 1.25, :Er => 0.23, :Hf => 4.69, :O => 33.63)
    @test mineralcompositions["Forsterite"] == Dict(:Mg => 34.55, :O => 45.49, :Si => 19.96)
    @test mineralcompositions["Annite"] == Dict(:Al => 5.26, :F => 1.85, :Fe => 32.67, :H => 0.29, :K => 7.62, :O => 35.87, :Si => 16.43)
