## --- Resampling.jl
    ...
    @test bsr!(Array{Int64}(undef,1000),Array{Int64}(undef,1000),1:10,0,1000,0.5) |> unique ⊆ 1:10
    @test bsr!(Array{Int64}(undef,1000),Array{Int64}(undef,1000),1:10,0,1000,fill(0.5,1000)) |> unique ⊆ 1:10
    @test bsr!(Array{Int64}(undef,1000),Array{Int64}(undef,1000),1:10,fill(0,10),1000,0.5) |> unique ⊆ 1:10
    @test bsr!(Array{Int64}(undef,1000),Array{Int64}(undef,1000),1:10,fill(0,10),1000,fill(0.5,1000)) |> unique ⊆ 1:10
